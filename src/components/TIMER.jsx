...
const getFormattedTime=(milli)=>{
    ...
    return(
        ...
        <div className="flex justify-evenly border-2 border-violet-300 p-1">
            ...
            <button  className="bg-[#801336] hover:bg-[#510A32] rounded-md text-white px-1 mx-3">Start</button>
            <button  className="bg-[#801336] hover:bg-[#510A32] rounded-md text-white px-1 mx-3">Pause</button>
        </div>
