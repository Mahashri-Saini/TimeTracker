...
function FirstPage() {
  return (
    ...
    <div className="flex flex-col m-6 ">
      ...
      {/* //bottom part */}
        <div> 
             <p className="m-10 text-4xl p-4 rounded-lg border-4 border-double border-[#801336] w-[70%]">"Make count of every second, every moment will take you a step closer to PERFECT YOU." </p>
        </div>
    </div>
      ...
      <div className=" flex flex-col justify-around text-4xl m-6 p-5 h-6/6 border-4 w-[50%] border-dashed border-[#801336] rounded-lg">
